...
constexpr HardwareConfig NON_CAMERA_VERSION_CONFIG = {
    ...
    .right_leg_pin = GPIO_NUM_18,
    .right_foot_pin = GPIO_NUM_38,
    .left_leg_pin = GPIO_NUM_17,
    .left_foot_pin = GPIO_NUM_39,
...
#ifndef ROBOT_LAN_BASE_URL
#define ROBOT_LAN_BASE_URL "http://10.209.0.216"
#endif

#ifndef OTTO_WS_CONTROL_ENABLED
#define OTTO_WS_CONTROL_ENABLED 1
#endif

#ifndef OTTO_WS_CONTROL_PORT
#define OTTO_WS_CONTROL_PORT 8080
#endif

#ifndef OTTO_WS_CONTROL_TOKEN
#define OTTO_WS_CONTROL_TOKEN ""
#endif
