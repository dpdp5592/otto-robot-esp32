...
using McpReplyCallback = std::function<void(const std::string& payload)>;
...
public:
    ...
    void ParseMessage(const cJSON* json, const McpReplyCallback& reply_callback);
    void ParseMessage(const std::string& message, const McpReplyCallback& reply_callback);
...
private:
    ...
    void ReplyResult(int id, const std::string& result, const McpReplyCallback& reply_callback = nullptr);
    void ReplyError(int id, const std::string& message, const McpReplyCallback& reply_callback = nullptr);

    void GetToolsList(int id, const std::string& cursor, bool list_user_only_tools, const McpReplyCallback& reply_callback = nullptr);
    void DoToolCall(int id, const std::string& tool_name, const cJSON* tool_arguments, const McpReplyCallback& reply_callback = nullptr);
